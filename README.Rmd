...
An **access key** is required in order to sucessfully send the request. It will be granted to each user individually.
...
* **accuracy_crit**: which criterion to measure the accuracy of the forecast during the CV (can be MPE, MAPE, WMAPE or RMSE); 
